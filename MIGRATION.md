...
directories to serve static content — it doesn't need to _own_ anything.
...
Since this is the same live domain, testing after deploy _is_ testing
...
## 5. Rollback (fast, since old files were moved not deleted)
